    ...
    <div className='flex justify-center items-center h-screen bg-gray-100'>
      <div className='bg-white shadow-lg rounded-lg w-full max-w-md px-6 py-8'>
        ...
        <Form
          ...
          className='mt-6'
        >
          <Form.Item name='name' label='Họ và tên' rules={[{ required: true, message: 'Họ và tên không được trống!' }]}>
          ...
          >
            <Input
              type='password'
              size='large'
              className='rounded-md border-gray-300 focus:border-red-600 focus:ring-red-600'
            />
          </Form.Item>
          <Form.Item>
            <button
